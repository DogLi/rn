...
#[macro_use]
extern crate clap;
#[macro_use(slog_log, slog_error, slog_debug, slog_info, slog_record, slog_b, slog_record_static,
            slog_kv)]
extern crate slog;
...
fn main() {
    ...
    let config_path = tilde(matches.value_of("config").unwrap_or("~/bin/settings.toml"))
        .into_owned();
